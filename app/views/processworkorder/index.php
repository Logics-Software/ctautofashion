...
@media (max-width: 1024px) and (min-width: 768px) {
    ...
    .main-table th:nth-child(3), .main-table td:nth-child(3) { width: 25%; } /* Customer */
    .main-table th:nth-child(5), .main-table td:nth-child(5) { width: 12%; } /* Telepon */
    .main-table th:nth-child(6), .main-table td:nth-child(6) { width: 12%; }  /* No Polisi */
    .main-table th:nth-child(7), .main-table td:nth-child(7) { width: 17%; } /* Kendaraan */
    .main-table th:nth-child(8), .main-table td:nth-child(8) { width: 12%; } /* Status */
}
...
/* Detail table for service and item sections */
.detail-table td {
